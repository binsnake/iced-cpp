...
namespace iced_x86 {
	...
	void InstructionInfoFactory::add_memory(const Instruction& instruction, OpAccess access) noexcept {
		...
		mem.memory_size = instruction.memory_size_enum();
		mem.access = access;
	...
	namespace InstructionExtensions {
		...
		size_t get_operand_size(Register reg) noexcept {
			switch (reg) {
				// 8-bit registers
			case Register::AL: case Register::BL: case Register::CL: case Register::DL:
			case Register::AH: case Register::BH: case Register::CH: case Register::DH:
			case Register::SIL: case Register::DIL: case Register::BPL: case Register::SPL:
			case Register::R8_L: case Register::R9_L: case Register::R10_L: case Register::R11_L:
			case Register::R12_L: case Register::R13_L: case Register::R14_L: case Register::R15_L:
				return 1;

				// 16-bit registers
			case Register::AX: case Register::BX: case Register::CX: case Register::DX:
			case Register::SI: case Register::DI: case Register::BP: case Register::SP:
			case Register::R8_W: case Register::R9_W: case Register::R10_W: case Register::R11_W:
			case Register::R12_W: case Register::R13_W: case Register::R14_W: case Register::R15_W:
				return 2;

				// 32-bit registers
			case Register::EAX: case Register::EBX: case Register::ECX: case Register::EDX:
			case Register::ESI: case Register::EDI: case Register::EBP: case Register::ESP:
			case Register::R8_D: case Register::R9_D: case Register::R10_D: case Register::R11_D:
			case Register::R12_D: case Register::R13_D: case Register::R14_D: case Register::R15_D:
			case Register::EIP:
				return 4;

				// 64-bit registers
			case Register::RAX: case Register::RBX: case Register::RCX: case Register::RDX:
			case Register::RSI: case Register::RDI: case Register::RBP: case Register::RSP:
			...
			case Register::RIP:
				...
				// XMM registers
			case Register::XMM0: case Register::XMM1: case Register::XMM2: case Register::XMM3:
			case Register::XMM4: case Register::XMM5: case Register::XMM6: case Register::XMM7:
			case Register::XMM8: case Register::XMM9: case Register::XMM10: case Register::XMM11:
			case Register::XMM12: case Register::XMM13: case Register::XMM14: case Register::XMM15:
			case Register::XMM16: case Register::XMM17: case Register::XMM18: case Register::XMM19:
			case Register::XMM20: case Register::XMM21: case Register::XMM22: case Register::XMM23:
			case Register::XMM24: case Register::XMM25: case Register::XMM26: case Register::XMM27:
			case Register::XMM28: case Register::XMM29: case Register::XMM30: case Register::XMM31:
				return 16;

				// Control/debug registers
			case Register::CR0: case Register::CR2: case Register::CR3: case Register::CR4: case Register::CR8:
			case Register::DR0: case Register::DR1: case Register::DR2: case Register::DR3:
			case Register::DR4: case Register::DR5: case Register::DR6: case Register::DR7:
				return 8;

				// Segment registers
			case Register::CS: case Register::DS: case Register::ES: case Register::FS:
			case Register::GS: case Register::SS:
				return 2;
		...
		size_t get_operand_size_at_index(Instruction* instr, size_t operand_index) noexcept {
			switch (instr->op_kind(operand_index)) {
			case OpKind::REGISTER:
				return get_operand_size(instr->op_register(operand_index));
			case OpKind::MEMORY:
				return static_cast<size_t>(instr->memory_size());
